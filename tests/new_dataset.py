...
self.parcellation_chooser_window.ctl.new_dataset_name='sample_laus125'
...
self.adjmat_chooser_window._current_dataset_list=[
	self.controller.ds_instances['sample_laus125']]
self.adjmat_chooser_window.ctl.adjmat='data/sample_laus125.npy'
